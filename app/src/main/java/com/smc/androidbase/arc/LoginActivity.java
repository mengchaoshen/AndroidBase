...
//        loginBean.setUserNameGDs("smc");
//        loginBean.setPassword("Xxzj88088175");
//        UserService userService = HttpUtils.getInstance().getRetrofitClient().create(UserService.class);
//        userService.getLoginAsp()
...
//
//                    @Override
//                    public void onNext(String loginAsp) {
//                        Log.d(TAG, "loginAsp = " + loginAsp);
//                        String userNameKey = getUserNameKeyByLoginAsp(loginAsp);
